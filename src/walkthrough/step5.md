...
Click the magic wand icon to make your prompt clearer and more complete. ZyAgent will rewrite it to get better results.

# Add files or folders for context

Mention files or folders in your prompt. ZyAgent will use them to better understand and respond to your request.
